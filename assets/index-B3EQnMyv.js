...
}`;function av(n){const e=document.createElement("style");e.innerHTML=n;const t=document.querySelector("head link[rel=stylesheet], head style");t?document.head.insertBefore(e,t):document.head.appendChild(e)}let zu=!1;class Ul{constructor({parent:e,autoPlace:t=e===void 0,container:i,width:s,title:r="Controls",closeFolders:o=!1,injectStyles:a=!0,touchStyles:l=!0}={}){if(this.parent=e,this.root=e?e.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("button"),this.$title.classList.add("title"),this.$title.setAttribute("aria-expanded",!0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(r),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),l&&this.domElement.classList.add("allow-touch-styles"),!zu&&a&&(av(ov),zu=!0),i?i.appendChild(this.domElement):t&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),s&&this.domElement.style.setProperty("--width",s+"px"),this._closeFolders=o}add(e,t,i,s,r){if(Object(i)===i)return new sv(this,e,t,i);const o=e[t];switch(typeof o){case"number":return new iv(this,e,t,i,s,r);case"boolean":return new j0(this,e,t);case"string":return new rv(this,e,t);case"function":return new ea(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,o)}addColor(e,t,i=1){return new nv(this,e,t,i)}addFolder(e){const t=new Ul({parent:this,title:e});return this.root._closeFolders&&t.close(),t}load(e,t=!0){return e.controllers&&this.controllers.forEach(i=>{i instanceof ea||i._name in e.controllers&&i.load(e.controllers[i._name])}),t&&e.folders&&this.folders.forEach(i=>{i._title in e.folders&&i.load(e.folders[i._title])}),this}save(e=!0){const t={controllers:{},folders:{}};return this.controllers.forEach(i=>{if(!(i instanceof ea)){if(i._name in t.controllers)throw new Error(`Cannot save GUI with duplicate property "${i._name}"`);t.controllers[i._name]=i.save()}}),e&&this.folders.forEach(i=>{if(i._title in t.folders)throw new Error(`Cannot save GUI with duplicate folder "${i._title}"`);t.folders[i._title]=i.save()}),t}open(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(e){this._closed!==e&&(this._closed=e,this._callOnOpenClose(this))}show(e=!0){return this._hidden=!e,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const t=this.$children.clientHeight;this.$children.style.height=t+"px",this.domElement.classList.add("transition");const i=r=>{r.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",i))};this.$children.addEventListener("transitionend",i);const s=e?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!e),requestAnimationFrame(()=>{this.$children.style.height=s+"px"})}),this}title(e){return this._title=e,this.$title.textContent=e,this}reset(e=!0){return(e?this.controllersRecursive():this.controllers).forEach(i=>i.reset()),this}onChange(e){return this._onChange=e,this}_callOnChange(e){this.parent&&this.parent._callOnChange(e),this._onChange!==void 0&&this._onChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onFinishChange(e){return this._onFinishChange=e,this}_callOnFinishChange(e){this.parent&&this.parent._callOnFinishChange(e),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onOpenClose(e){return this._onOpenClose=e,this}_callOnOpenClose(e){this.parent&&this.parent._callOnOpenClose(e),this._onOpenClose!==void 0&&this._onOpenClose.call(this,e)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(e=>e.destroy())}controllersRecursive(){let e=Array.from(this.controllers);return this.folders.forEach(t=>{e=e.concat(t.controllersRecursive())}),e}foldersRecursive(){let e=Array.from(this.folders);return this.folders.forEach(t=>{e=e.concat(t.foldersRecursive())}),e}}const{chosenLevel:lv,manageEndgame:cv,redoGame:uv,beginGame:hv,restartTime:fv,manageWin:Mu}=ci();class dv{constructor(e){We(this,"scene");We(this,"renderer");We(this,"camera");We(this,"meshs");We(this,"ref");We(this,"pixelRatio");We(this,"animationFrameId",null);We(this,"mousePos");We(this,"mouseDirection");We(this,"character",null);We(this,"environment",null);We(this,"layer");We(this,"clock");We(this,"delta");We(this,"sensitivity");We(this,"fov");We(this,"handleMouseMove",e=>{this.moveVision(e)});const{width:t,height:i}=e.getBoundingClientRect();this.meshs=[],this.mousePos={x:0,y:0},this.ref=e,this.scene=new kc,this.fov={base:90,current:90,accel:110,isChanging:!1,isAccelerate:!1,isDecelerate:!1},this.camera=new Yt(this.fov.base,t/i,.1,10),this.camera.position.set(0,0,0),this.camera.lookAt(0,0,0),this.layer=lv.value,this.clock=new ux,this.delta=0,this.sensitivity=.002,this.mouseDirection=new B(0,0,1),this.pixelRatio=Math.min(window.devicePixelRatio,2),this.renderer=new q0({antialias:!0}),this.renderer.setClearColor(0,0),this.renderer.setPixelRatio(this.pixelRatio);const s=window.devicePixelRatio>1;this.renderer.setSize(t,i,s),e.appendChild(this.renderer.domElement),this.setup()}tick(){this.renderer.render(this.scene,this.camera),this.animationFrameId=requestAnimationFrame(()=>{this.tick(),this.delta=this.clock.getDelta(),this.checkFov(),this.tickChildren()})}setup(){this.environment=new Y0(this),this.character=new K0(this),this.meshs.push(this.environment,this.character),this.addChildren(),this.setupGUI(),this.setView(),this.registerEventListeners(),this.tick(),setTimeout(()=>{this.character.canMove=!0},100)}changeFov(e,t){this.fov.current=(1-.1)*e+.1*t,this.camera.fov=this.fov.current,this.camera.updateProjectionMatrix()}setupGUI(){var r,o,a;const e=new Ul({title:"Acker'tools",closeFolders:!0}),t=e.addFolder("Environment"),i=e.addFolder("Camera"),s=e.addFolder("Light");e.hide(),i.add(this.camera,"fov",20,140,.5).name("FOV").onChange(()=>{this.camera.updateProjectionMatrix()}),s.add((r=this.character)==null?void 0:r.light,"distance",.1,7,.05).name("distance light"),s.addColor((o=this.character)==null?void 0:o.light,"color").name("color light").onChange(l=>{console.log(l.getHexString())}),t.add((a=this.environment)==null?void 0:a.mesh.children[0].material,"wireframe").name("ground wireframe"),window.addEventListener("keydown",l=>{l.key=="t"&&e.show(e._hidden)})}checkFov(){this.fov.isChanging&&(this.fov.isAccelerate&&this.changeFov(this.fov.current,this.fov.accel),this.fov.isDecelerate&&this.changeFov(this.fov.current,this.fov.base))}restart(e){this.layer=e,this.scene=new kc,fv(),hv(),this.setup()}stop(){this.animationFrameId!==null&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null),this.environment=null,this.character=null,this.meshs=[]}addChildren(){for(let e=0;e<this.meshs.length;e++)this.scene.add(this.meshs[e].mesh)}tickChildren(){for(let e=0;e<this.meshs.length;e++)this.meshs[e].tick(this)}setView(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight),this.pixelRatio=Math.min(window.devicePixelRatio,2),this.renderer.setPixelRatio(this.pixelRatio)}moveVision(e){const t=e.movementX;this.camera.rotation.reorder("YXZ"),this.camera.rotation.y-=t*this.sensitivity}showEndGame(e){Mu(e==="win"),uv(),cv()}enablePointerLock(){document.body.requestPointerLock(),document.addEventListener("mousemove",this.handleMouseMove)}disablePointerLock(){document.exitPointerLock(),document.removeEventListener("mousemove",this.handleMouseMove)}registerEventListeners(){window.onresize=()=>{this.setView()},window.addEventListener("mousemove",e=>{this.mousePos={x:e.clientX,y:e.clientY}}),window.addEventListener("finishLevel",()=>{this.stop(),this.disablePointerLock(),this.showEndGame("win")}),window.addEventListener("loseGame",()=>{this.stop(),this.disablePointerLock(),this.showEndGame("lose")})}}const pv={class:"Panel__menu"},mv={class:"Panel__menu__items__subjects"},xv={class:"Panel__menu__items__content"},gv={key:0,class:"Content--mission"},_v={key:1,class:"Content--controls"},vv=Ui({__name:"Panel",setup(n){const{panelIsVisible:e,displayMenu:t,displayBeginMenu:i}=ci(),s=en(!0),r=en(!1),o=()=>{s.value=!0,r.value=!1},a=()=>{s.value=!1,r.value=!0};return(l,c)=>(It(),an("section",{class:Bn(["Panel",Ft(e)?"Panel--activate enter":"leave"])},[ht("div",pv,[ht("div",{class:Bn(["Panel__menu__items",Ft(e)?"":"contentLeave"])},[ht("div",mv,[ht("button",{onClick:c[0]||(c[0]=u=>o())},c[4]||(c[4]=[ht("h5",null,"Mission",-1)])),ht("button",{onClick:c[1]||(c[1]=u=>a())},c[5]||(c[5]=[ht("h5",null,"Controls",-1)]))]),ht("div",xv,[s.value?(It(),an("div",gv,c[6]||(c[6]=[kr('<p style="border-left:2px solid white;padding-left:15px;" data-v-8aefbe6a> Copilote.. Co... Copilote ? <br data-v-8aefbe6a> Copilote ? <br data-v-8aefbe6a> Vous m&#39;entendez ? <br data-v-8aefbe6a> On s&#39;est écrasés ici dans ce.. ce monde étrange <br data-v-8aefbe6a> Nous devons sortir de là.. et.. au plus vite ! </p><p class="Content--mission__instructions" data-v-8aefbe6a> Vous avez 2 minutes pour sortir de cet endroit. Au clic sur le bouton <strong data-v-8aefbe6a>&quot;Jouer&quot;</strong>, le chronomètre se déclenchera. <br data-v-8aefbe6a> N&#39;oubliez pas de vérifier dans <strong data-v-8aefbe6a>&quot;Controls&quot;</strong> les controles du jeu ! <br data-v-8aefbe6a> Bonne chance ! </p>',2)]))):bi("",!0),r.value?(It(),an("div",_v,c[7]||(c[7]=[kr('<div class="Control--menu" data-v-8aefbe6a><div class="Control" data-v-8aefbe6a><p class="Key Key--large" data-v-8aefbe6a>Shift</p><p data-v-8aefbe6a>Courir</p></div></div><div class="Content--controls__layout" data-v-8aefbe6a><div class="Control" data-v-8aefbe6a><p class="Key" data-v-8aefbe6a>Z</p><p data-v-8aefbe6a>Avancer</p></div><div class="Control--group" data-v-8aefbe6a><div class="Control" data-v-8aefbe6a><p class="Key" data-v-8aefbe6a>Q</p><p data-v-8aefbe6a>Gauche</p></div><div class="Control" data-v-8aefbe6a><p class="Key" data-v-8aefbe6a>S</p><p data-v-8aefbe6a>Reculer</p></div><div class="Control" data-v-8aefbe6a><p class="Key" data-v-8aefbe6a>D</p><p data-v-8aefbe6a>Droite</p></div></div></div><div class="Control--menu" data-v-8aefbe6a><div class="Control" data-v-8aefbe6a><p class="Key" data-v-8aefbe6a>F</p><p data-v-8aefbe6a>Pause</p></div></div>',3)]))):bi("",!0)])],2),ht("div",null,[Ft(i)?(It(),an("button",{key:0,onClick:c[2]||(c[2]=u=>l.$emit("closePanelMenu")),class:"PlayButton"}," Jouer ")):bi("",!0),Ft(t)?(It(),an("button",{key:1,onClick:c[3]||(c[3]=u=>l.$emit("closePanelRedoMenu")),class:"PlayButton"}," Recommencer ")):bi("",!0)])])],2))}}),Ni=(n,e)=>{const t=n.__vccOpts||n;for(const[i,s]of e)t[i]=s;return t},zv=Ni(vv,[["__scopeId","data-v-8aefbe6a"]]),Mv={class:"HUD__timer"},Sv=Ui({__name:"HUD",setup(n){const{panelIsVisible:e,stopEvent:t,timeRemaining:i,openPanel:s,redoGame:r,restartTime:o}=ci(),a=bh(()=>{const l=Math.floor(i.value/60),c=i.value%60;return`${String(l).padStart(2,"0")}:${String(c).padStart(2,"0")}`});return _l(()=>{setInterval(()=>{i.value>0?e.value||i.value--:(window.dispatchEvent(t),r(),s(),o())},1e3)}),(l,c)=>(It(),an("section",{class:Bn(["HUD",Ft(e)?"leave":"HUD--activate enter"])},[c[0]||(c[0]=kr('<div class="HUD__boussole" data-v-d893db98><p class="HUD__boussole--North" data-v-d893db98>N</p><p class="HUD__boussole--North--point" data-v-d893db98>^</p><p class="HUD__boussole--South" data-v-d893db98>S</p><p class="HUD__boussole--West" data-v-d893db98>O</p><p class="HUD__boussole--East" data-v-d893db98>E</p></div>',1)),ht("div",Mv,ol(a.value),1),c[1]||(c[1]=ht("div",{class:"HUD__pointer"},null,-1))],2))}}),Ev=Ni(Sv,[["__scopeId","data-v-d893db98"]]),yv="/lab-fps/fpsgunr.png",bv=Ui({__name:"Gun",setup(n){const{panelIsVisible:e}=ci();return(t,i)=>(It(),an("section",{class:Bn(["Gun",Ft(e)?"leave":"Gun--activate enter"])},i[0]||(i[0]=[ht("img",{src:yv},null,-1)]),2))}}),Tv=Ni(bv,[["__scopeId","data-v-85ffe662"]]),Av={class:"Endgame__menu"},wv=Ui({__name:"Endgame",setup(n){const{endgameIsVisible:e,closeEndgame:t,win:i}=ci();return(s,r)=>(It(),an("section",{class:Bn(["Endgame",Ft(e)?"Endgame--activate enter":"leave"])},[ht("div",Av,[ht("div",{class:Bn(["Endgame__menu__items",Ft(e)?"":"contentLeave"])},[ht("h2",null,ol(Ft(i)?"Félicitations ! Vous vous en êtes bien sorti copilote !":"Oh non.. noooon.. copilote.. je suis arrivé trop tard.. "),1),ht("button",{onClick:r[0]||(r[0]=o=>Ft(t)())},"Continuer")],2)])],2))}}),Cv=Ni(wv,[["__scopeId","data-v-04ea5bd5"]]),Rv={class:"Home"},Pv=Ui({__name:"Game",setup(n){const{closePanel:e,openPanel:t,beginGame:i,choseLevel:s,endgameIsVisible:r}=ci();let o;const a=en(),l=()=>{e(),i(),o.enablePointerLock()},c=()=>{e(),i(),o.restart(s()),o.enablePointerLock()};return _l(()=>{o=new dv(a.value),window.addEventListener("keydown",u=>{u.key.toLowerCase()=="f"&&(t(),o.disablePointerLock())})}),(u,h)=>(It(),an("section",Rv,[ht("div",{ref_key:"scene",ref:a,class:"Scene"},null,512),jt(zv,{onClosePanelMenu:h[0]||(h[0]=d=>l()),onClosePanelRedoMenu:h[1]||(h[1]=d=>c())}),Ft(r)?(It(),Gr(Cv,{key:0})):bi("",!0),jt(Ev),jt(Tv),h[2]||(h[2]=ht("div",{class:"IntroGame"},null,-1))]))}}),Lv=Ni(Pv,[["__scopeId","data-v-d3884fc4"]]),Dv={class:"Intro"},Iv=Ui({__name:"Intro",setup(n){const{manageIntro:e}=ci();return(t,i)=>(It(),an("section",Dv,[i[2]||(i[2]=kr('<div class="Intro__boussole Intro__boussole--big" data-v-8c5a6fe4><p class="Intro__boussole--North" data-v-8c5a6fe4>N</p><p class="Intro__boussole--North--point" data-v-8c5a6fe4>^</p><p class="Intro__boussole--South" data-v-8c5a6fe4>S</p><p class="Intro__boussole--West" data-v-8c5a6fe4>O</p><p class="Intro__boussole--East" data-v-8c5a6fe4>E</p><div class="Intro__boussole Intro__boussole--small" data-v-8c5a6fe4><p class="Intro__boussole--North" data-v-8c5a6fe4>N</p><p class="Intro__boussole--North--point" data-v-8c5a6fe4>^</p><p class="Intro__boussole--South" data-v-8c5a6fe4>S</p><p class="Intro__boussole--West" data-v-8c5a6fe4>O</p><p class="Intro__boussole--East" data-v-8c5a6fe4>E</p></div></div>',1)),ht("div",null,[i[1]||(i[1]=ht("h1",null,"DOOMO",-1)),ht("button",{onClick:i[0]||(i[0]=s=>Ft(e)())},"Commencer")])]))}}),Uv=Ni(Iv,[["__scopeId","data-v-8c5a6fe4"]]),Fv={class:"Home"},Nv=Ui({__name:"App",setup(n){const{displayIntro:e}=ci();return(t,i)=>(It(),an("div",Fv,[Ft(e)?bi("",!0):(It(),Gr(Lv,{key:0})),Ft(e)?(It(),Gr(Uv,{key:1})):bi("",!0)]))}}),Ov=Ni(Nv,[["__scopeId","data-v-67266ce0"]]);Dp(Ov).mount("#app");
