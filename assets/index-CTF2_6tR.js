...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:$n,depthTest:!1,depthWrite:!1})}function Eu(){return new Lt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ec(),fragmentShader:`
		...
		`,blending:$n,depthTest:!1,depthWrite:!1})}function yu(){return new Lt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ec(),fragmentShader:`
...
}`;function mS(n){const e=document.createElement("style");e.innerHTML=n;const t=document.querySelector("head link[rel=stylesheet], head style");t?document.head.insertBefore(e,t):document.head.appendChild(e)}let $u=!1;class tc{constructor({parent:e,autoPlace:t=e===void 0,container:i,width:s,title:r="Controls",closeFolders:o=!1,injectStyles:a=!0,touchStyles:l=!0}={}){if(this.parent=e,this.root=e?e.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("button"),this.$title.classList.add("title"),this.$title.setAttribute("aria-expanded",!0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(r),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),l&&this.domElement.classList.add("allow-touch-styles"),!$u&&a&&(mS(pS),$u=!0),i?i.appendChild(this.domElement):t&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),s&&this.domElement.style.setProperty("--width",s+"px"),this._closeFolders=o}add(e,t,i,s,r){if(Object(i)===i)return new fS(this,e,t,i);const o=e[t];switch(typeof o){case"number":return new hS(this,e,t,i,s,r);case"boolean":return new sS(this,e,t);case"string":return new dS(this,e,t);case"function":return new ga(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,o)}addColor(e,t,i=1){return new uS(this,e,t,i)}addFolder(e){const t=new tc({parent:this,title:e});return this.root._closeFolders&&t.close(),t}load(e,t=!0){return e.controllers&&this.controllers.forEach(i=>{i instanceof ga||i._name in e.controllers&&i.load(e.controllers[i._name])}),t&&e.folders&&this.folders.forEach(i=>{i._title in e.folders&&i.load(e.folders[i._title])}),this}save(e=!0){const t={controllers:{},folders:{}};return this.controllers.forEach(i=>{if(!(i instanceof ga)){if(i._name in t.controllers)throw new Error(`Cannot save GUI with duplicate property "${i._name}"`);t.controllers[i._name]=i.save()}}),e&&this.folders.forEach(i=>{if(i._title in t.folders)throw new Error(`Cannot save GUI with duplicate folder "${i._title}"`);t.folders[i._title]=i.save()}),t}open(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(e){this._closed!==e&&(this._closed=e,this._callOnOpenClose(this))}show(e=!0){return this._hidden=!e,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const t=this.$children.clientHeight;this.$children.style.height=t+"px",this.domElement.classList.add("transition");const i=r=>{r.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",i))};this.$children.addEventListener("transitionend",i);const s=e?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!e),requestAnimationFrame(()=>{this.$children.style.height=s+"px"})}),this}title(e){return this._title=e,this.$title.textContent=e,this}reset(e=!0){return(e?this.controllersRecursive():this.controllers).forEach(i=>i.reset()),this}onChange(e){return this._onChange=e,this}_callOnChange(e){this.parent&&this.parent._callOnChange(e),this._onChange!==void 0&&this._onChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onFinishChange(e){return this._onFinishChange=e,this}_callOnFinishChange(e){this.parent&&this.parent._callOnFinishChange(e),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onOpenClose(e){return this._onOpenClose=e,this}_callOnOpenClose(e){this.parent&&this.parent._callOnOpenClose(e),this._onOpenClose!==void 0&&this._onOpenClose.call(this,e)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(e=>e.destroy())}controllersRecursive(){let e=Array.from(this.controllers);return this.folders.forEach(t=>{e=e.concat(t.controllersRecursive())}),e}foldersRecursive(){let e=Array.from(this.folders);return this.folders.forEach(t=>{e=e.concat(t.foldersRecursive())}),e}}const{chosenLevel:gS,panelIsVisible:_a,bullets:as,wave:Yu,enemies:_S,manageEndgame:xS,redoGame:vS,beginGame:MS,restartTime:SS,manageWin:qu}=Jn();class ES{constructor(e){Ee(this,"scene");Ee(this,"renderer");Ee(this,"camera");Ee(this,"meshs");Ee(this,"stats");Ee(this,"ref");Ee(this,"pixelRatio");Ee(this,"animationFrameId",null);Ee(this,"mousePos");Ee(this,"mouseDirection");Ee(this,"character",null);Ee(this,"environment",null);Ee(this,"enemy",null);Ee(this,"layer");Ee(this,"clock");Ee(this,"delta");Ee(this,"elapsedTime");Ee(this,"sensitivity");Ee(this,"globalLight");Ee(this,"fov");Ee(this,"composer");Ee(this,"setBulletInterval");Ee(this,"handleBulletTrigger",()=>{this.triggerBullet()});Ee(this,"handleMouseMove",e=>{this.moveVision(e)});const{width:t,height:i}=e.getBoundingClientRect();this.setBulletInterval=null,this.enemy=[],this.meshs=[],this.mousePos={x:0,y:0},this.ref=e,this.scene=new uu,this.fov={base:90,current:90,accel:110,portal:160,isChanging:!1,isPortal:!1,isAccelerate:!1,isDecelerate:!1},this.camera=new Jt(this.fov.base,t/i,.1,24),this.camera.position.set(0,0,0),this.camera.lookAt(0,0,0),this.layer=gS.value,this.clock=new Uf,this.elapsedTime=0,this.delta=0,this.sensitivity=.002,this.mouseDirection=new F(0,0,1),this.pixelRatio=Math.min(window.devicePixelRatio,2),this.renderer=new NM({antialias:!0}),this.composer=new Gu(this.renderer),this.composer.renderTarget1.samples=8,this.composer.renderTarget2.samples=8,this.renderer.setClearColor(0,0),this.renderer.setPixelRatio(this.pixelRatio);const s=window.devicePixelRatio>1;this.composer.setSize(window.innerWidth,window.innerHeight),this.renderer.setSize(t,i,s);const r=new ku(this.scene,this.camera);this.composer.addPass(r);const o=new Oi;o.strength=.4,o.radius=.5,this.composer.addPass(o);const a=new XM;a.enabled=!1,this.composer.addPass(a),console.log(a);const l=new Wu;this.composer.addPass(l),this.globalLight=new Qg(5772643,0),this.scene.add(this.globalLight),e.appendChild(this.renderer.domElement),this.setup()}tick(){this.composer.render(),_a.value===!1&&(this.delta=this.clock.getDelta(),this.elapsedTime=this.clock.getElapsedTime(),this.tickChildren()),this.checkFov(),this.animationFrameId=requestAnimationFrame(()=>{this.tick()})}setup(){var t;const e=[new Br(this,30),new Br(this,30),new Br(this,30)];this.environment=new eS(this),this.character=new nS(this),(t=this.enemy)==null||t.push(...e),this.meshs.push(this.environment,this.character,...this.enemy),as.value=300,this.resetHUDEnemies(),this.addChildren(),this.setupGUI(),this.setView(),this.registerEventListeners(),this.tick(),setTimeout(()=>{this.character.canMove=!0},100)}setupGUI(){var o,a,l;const e=new tc({title:"Acker'tools",closeFolders:!0}),t=e.addFolder("Environment"),i=e.addFolder("ShaderPP"),s=e.addFolder("Camera"),r=e.addFolder("Light");e.hide(),s.add(this.camera,"fov",20,140,.5).name("FOV").onChange(()=>{this.camera.updateProjectionMatrix()}),r.add((o=this.character)==null?void 0:o.light,"distance",.1,7,.05).name("distance light"),r.addColor((a=this.character)==null?void 0:a.light,"color").name("color light").onChange(c=>{console.log(c.getHexString())}),t.add((l=this.environment)==null?void 0:l.mesh.children[0].material,"wireframe").name("ground wireframe"),i.add(this.composer.passes[1],"strength",.1,5).name("strength"),window.addEventListener("keydown",c=>{c.key=="t"&&e.show(e._hidden)})}changeFov(e,t){this.fov.current=(1-.1)*e+.1*t,this.camera.fov=this.fov.current,this.camera.updateProjectionMatrix()}changePortalFov(e,t){this.fov.current=(1-.07)*e+.07*t,this.camera.fov=this.fov.current,this.camera.updateProjectionMatrix()}checkFov(){this.fov.isChanging&&(this.fov.isAccelerate&&this.changeFov(this.fov.current,this.fov.accel),this.fov.isDecelerate&&this.changeFov(this.fov.current,this.fov.base)),this.fov.isPortal&&(this.fov.isAccelerate&&this.changePortalFov(this.fov.current,this.fov.portal),this.fov.isDecelerate&&this.changeFov(this.fov.current,this.fov.base))}restart(e){this.layer=e,this.scene=new uu;const t=new ku(this.scene,this.camera);this.composer=new Gu(this.renderer),this.composer.addPass(t);const i=new Oi;i.strength=.4,i.radius=.5,this.composer.addPass(i);const s=new Wu;this.composer.addPass(s),SS(),MS(),this.setup()}stop(){this.animationFrameId!==null&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null),this.environment=null,this.character=null,this.meshs=[],this.enemy=[]}addChildren(){for(let e=0;e<this.meshs.length;e++)this.scene.add(this.meshs[e].mesh)}tickChildren(){for(let e=0;e<this.meshs.length;e++)this.meshs[e].tick(this)}setView(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight),this.pixelRatio=Math.min(window.devicePixelRatio,2),this.renderer.setPixelRatio(this.pixelRatio)}moveVision(e){const t=e.movementX,i=e.movementY;this.camera.rotation.reorder("YXZ"),this.camera.rotation.y-=t*this.sensitivity,this.camera.rotation.x-=i*(this.sensitivity/2),this.camera.rotation.x=Math.min(Math.max(this.camera.rotation.x,-Math.PI*.5),Math.PI*.5)}showEndGame(e){qu(e==="win"),vS(),xS()}triggerBullet(){var e,t;clearInterval(this.setBulletInterval),this.setBulletInterval=null,as.value>0&&!_a.value&&(console.log("tir"),(e=this.character)==null||e.weaponEffect(),(t=this.character)==null||t.createBullet(),as.value-=1)}enablePointerLock(){document.body.requestPointerLock(),document.addEventListener("mousemove",this.handleMouseMove),document.addEventListener("mousedown",()=>{this.setBulletInterval===null&&!_a.value&&(this.setBulletInterval=setInterval(()=>{var e,t;as.value>0?((e=this.character)==null||e.weaponEffect(),(t=this.character)==null||t.createBullet(),as.value-=1):(clearInterval(this.setBulletInterval),this.setBulletInterval=null)},70))}),document.addEventListener("mouseup",()=>{clearInterval(this.setBulletInterval),this.setBulletInterval=null}),document.addEventListener("click",this.handleBulletTrigger)}disablePointerLock(){document.exitPointerLock(),document.removeEventListener("mousemove",this.handleMouseMove),document.removeEventListener("click",this.handleBulletTrigger)}setupNewWave(){for(let e=0;e<3;e++){const t=new Br(this,50+Yu.value*10);this.meshs.push(t),this.scene.add(t.mesh)}this.resetHUDEnemies()}resetHUDEnemies(){_S.value=[{life:50},{life:50},{life:50}]}grosMenageForWave(){this.meshs=this.meshs.filter((e,t)=>t<2),this.scene.children=this.scene.children.filter((e,t)=>t<3)}registerEventListeners(){window.onresize=()=>{this.setView()},window.addEventListener("mousemove",e=>{this.mousePos={x:e.clientX,y:e.clientY}}),window.addEventListener("loseGame",()=>{this.stop(),this.disablePointerLock(),this.showEndGame("lose")}),window.addEventListener("wave",()=>{as.value=3*(100+Yu.value*10),this.grosMenageForWave(),this.setupNewWave(),this.composer.passes[2].enabled=!0,setTimeout(()=>{this.composer.passes[2].enabled=!1},200)})}}const yS={class:"Panel__menu"},bS={class:"Panel__menu__items__subjects"},TS={class:"Panel__menu__items__content"},AS={key:0,class:"Content--mission"},wS={key:1,style:{display:"flex","flex-direction":"column","align-items":"center"}},CS=Hi({__name:"Panel",setup(n){const{panelIsVisible:e,displayMenu:t,displayBeginMenu:i}=Jn(),s=Ft(!0),r=Ft(!1),o=()=>{s.value=!0,r.value=!1},a=()=>{s.value=!1,r.value=!0};return(l,c)=>(mt(),At("section",{class:jn(["Panel",Mt(e)?"Panel--activate enter":"leave"])},[rt("div",yS,[rt("div",{class:jn(["Panel__menu__items",Mt(e)?"":"contentLeave"])},[rt("div",bS,[rt("button",{onClick:c[0]||(c[0]=u=>o())},c[4]||(c[4]=[rt("h5",null,"Mission",-1)])),rt("button",{onClick:c[1]||(c[1]=u=>a())},c[5]||(c[5]=[rt("h5",null,"Controls",-1)])),Mt(i)?(mt(),At("button",{key:0,onClick:c[2]||(c[2]=u=>l.$emit("closePanelMenu")),class:"PlayButton"}," Jouer ")):pn("",!0),Mt(t)?(mt(),At("button",{key:1,onClick:c[3]||(c[3]=u=>l.$emit("closePanelRedoMenu")),class:"PlayButton"}," Recommencer ")):pn("",!0)]),rt("div",TS,[s.value?(mt(),At("div",AS,c[6]||(c[6]=[io('<p style="border-left:2px solid white;padding-left:15px;" data-v-673bd9d6> Copilote.. Co... Copilote ? <br data-v-673bd9d6> Copilote ? <br data-v-673bd9d6> Vous m&#39;entendez ? <br data-v-673bd9d6> On s&#39;est écrasés ici dans ce.. ce monde étrange <br data-v-673bd9d6> Ça fait plusieurs heures que je suis seul.. <br data-v-673bd9d6> Je ne sais pas où je suis, ni comment je suis arrivé ici.. <br data-v-673bd9d6> Je me souviens juste des tornades... <br data-v-673bd9d6> On a percuté une tornade.. <br data-v-673bd9d6> Mais je suis sûr d&#39;une chose, je dois survivre ! </p><p class="Content--mission__instructions" data-v-673bd9d6> Vous avez 2 minutes pour détruire les ennemis de la map. Vague après vague les ennemis sont plus robustes. <br data-v-673bd9d6>Au clic sur le bouton <strong data-v-673bd9d6>&quot;Jouer&quot;</strong>, le chronomètre se déclenchera. <br data-v-673bd9d6> N&#39;oubliez pas de vérifier dans <strong data-v-673bd9d6>&quot;Controls&quot;</strong> les controles du jeu ! <br data-v-673bd9d6> Bonne chance ! </p>',2)]))):pn("",!0),r.value?(mt(),At("div",wS,c[7]||(c[7]=[io('<div class="Content--controls" data-v-673bd9d6><div class="Control--menu" data-v-673bd9d6><div class="Control" data-v-673bd9d6><p class="Key Key--large" data-v-673bd9d6>Shift</p><p data-v-673bd9d6>Courir</p></div></div><div class="Content--controls__layout" data-v-673bd9d6><div class="Control" data-v-673bd9d6><p class="Key" data-v-673bd9d6>Z</p><p data-v-673bd9d6>Avancer</p></div><div class="Control--group" data-v-673bd9d6><div class="Control" data-v-673bd9d6><p class="Key" data-v-673bd9d6>Q</p><p data-v-673bd9d6>Gauche</p></div><div class="Control" data-v-673bd9d6><p class="Key" data-v-673bd9d6>S</p><p data-v-673bd9d6>Reculer</p></div><div class="Control" data-v-673bd9d6><p class="Key" data-v-673bd9d6>D</p><p data-v-673bd9d6>Droite</p></div></div></div><div class="Control--menu" data-v-673bd9d6><div class="Control" data-v-673bd9d6><p class="Key" data-v-673bd9d6>F</p><p data-v-673bd9d6>Pause</p></div></div></div><div class="Control--menu--clic" data-v-673bd9d6><div class="Control--clic" data-v-673bd9d6><p class="Key--xlarge" data-v-673bd9d6>Clic gauche</p><p data-v-673bd9d6>Tirer</p></div></div>',2)]))):pn("",!0)])],2)])],2))}}),Gi=(n,e)=>{const t=n.__vccOpts||n;for(const[i,s]of e)t[i]=s;return t},RS=Gi(CS,[["__scopeId","data-v-673bd9d6"]]),PS="/lab-fps/balle.png",DS={style:{display:"flex","flex-direction":"column","align-items":"center"}},LS={class:"HUD__wave"},IS={key:0,class:"HUD__ennemies"},US={key:1,class:"HUD__waiting"},zS={class:"HUD__data"},FS={class:"HUD__timer"},NS={class:"HUD__bullets"},OS=Hi({__name:"HUD",setup(n){const{panelIsVisible:e,stopEvent:t,waveEvent:i,timeRemaining:s,wave:r,bullets:o,enemies:a,openPanel:l,redoGame:c,restartTime:u}=Jn();let h=0;const d=Jh(()=>{const p=Math.floor(s.value/60),_=s.value%60;return`${String(p).padStart(2,"0")}:${String(_).padStart(2,"0")}`});return Dl(()=>{setInterval(()=>{s.value>0&&(e.value||(s.value++,h++),h>0&&h%120===0&&(a.value.length>0?(window.dispatchEvent(t),c(),l(),u(),h=0):(window.dispatchEvent(i),u(),h=0,r.value++)))},1e3)}),(p,_)=>(mt(),At("section",{class:jn(["HUD",Mt(e)?"leave":"HUD--activate enter"])},[_[1]||(_[1]=io('<div class="HUD__boussole" data-v-f4214148><p class="HUD__boussole--North" data-v-f4214148>N</p><p class="HUD__boussole--North--point" data-v-f4214148>^</p><p class="HUD__boussole--South" data-v-f4214148>S</p><p class="HUD__boussole--West" data-v-f4214148>O</p><p class="HUD__boussole--East" data-v-f4214148>E</p></div>',1)),rt("div",DS,[rt("div",LS,"Wave "+Xs(Mt(r)),1),Mt(a).length>0?(mt(),At("div",IS,[(mt(!0),At(En,null,tp(Mt(a),(M,m)=>(mt(),At("div",{key:m,class:"HUD__ennemies__enemy"}))),128))])):pn("",!0),Mt(a).length===0?(mt(),At("div",US," Attendez la prochaine vague ")):pn("",!0)]),rt("div",zS,[rt("div",FS,Xs(d.value),1),rt("div",NS,[_[0]||(_[0]=rt("img",{src:PS},null,-1)),rt("span",null,Xs(Mt(o)),1)])]),_[2]||(_[2]=rt("div",{class:"HUD__pointer"},null,-1))],2))}}),BS=Gi(OS,[["__scopeId","data-v-f4214148"]]),HS="/lab-fps/fpsgunr.png",VS=Hi({__name:"Gun",setup(n){const{panelIsVisible:e}=Jn();return(t,i)=>(mt(),At("section",{class:jn(["Gun",Mt(e)?"leave":"Gun--activate enter"])},i[0]||(i[0]=[rt("img",{src:HS},null,-1)]),2))}}),GS=Gi(VS,[["__scopeId","data-v-85ffe662"]]),kS={class:"Endgame__menu"},WS=Hi({__name:"Endgame",setup(n){const{endgameIsVisible:e,closeEndgame:t,win:i}=Jn();return(s,r)=>(mt(),At("section",{class:jn(["Endgame",Mt(e)?"Endgame--activate enter":"leave"])},[rt("div",kS,[rt("div",{class:jn(["Endgame__menu__items",Mt(e)?"":"contentLeave"])},[rt("h2",null,Xs(Mt(i)?"Félicitations ! Vous vous en êtes bien sorti copilote !":"Oh non.. noooon.. copilote.. je suis arrivé trop tard.. "),1),rt("button",{onClick:r[0]||(r[0]=o=>Mt(t)())},"Continuer")],2)])],2))}}),XS=Gi(WS,[["__scopeId","data-v-04ea5bd5"]]),$S={class:"Home"},YS=Hi({__name:"Game",setup(n){const{closePanel:e,openPanel:t,beginGame:i,choseLevel:s,endgameIsVisible:r}=Jn();let o;const a=Ft(),l=()=>{e(),i(),o.enablePointerLock()},c=()=>{e(),i(),o.restart(s()),o.enablePointerLock()};return Dl(()=>{o=new ES(a.value),window.addEventListener("keydown",u=>{u.key.toLowerCase()=="f"&&(t(),o.disablePointerLock())})}),(u,h)=>(mt(),At("section",$S,[rt("div",{ref_key:"scene",ref:a,class:"Scene"},null,512),en(RS,{onClosePanelMenu:h[0]||(h[0]=d=>l()),onClosePanelRedoMenu:h[1]||(h[1]=d=>c())}),Mt(r)?(mt(),no(XS,{key:0})):pn("",!0),en(BS),en(GS),h[2]||(h[2]=rt("div",{class:"IntroGame"},null,-1))]))}}),qS=Gi(YS,[["__scopeId","data-v-d3884fc4"]]),jS={class:"Intro"},KS={key:1},ZS=Hi({__name:"Intro",setup(n){const{manageIntro:e}=Jn(),t=Ft(!1),i=()=>{t.value=!0,setTimeout(()=>{e()},100)};return(s,r)=>(mt(),At("section",jS,[r[2]||(r[2]=io('<div class="Intro__boussole Intro__boussole--big" data-v-c630c4ac><p class="Intro__boussole--North" data-v-c630c4ac>N</p><p class="Intro__boussole--North--point" data-v-c630c4ac>^</p><p class="Intro__boussole--South" data-v-c630c4ac>S</p><p class="Intro__boussole--West" data-v-c630c4ac>O</p><p class="Intro__boussole--East" data-v-c630c4ac>E</p><div class="Intro__boussole Intro__boussole--small" data-v-c630c4ac><p class="Intro__boussole--North" data-v-c630c4ac>N</p><p class="Intro__boussole--North--point" data-v-c630c4ac>^</p><p class="Intro__boussole--South" data-v-c630c4ac>S</p><p class="Intro__boussole--West" data-v-c630c4ac>O</p><p class="Intro__boussole--East" data-v-c630c4ac>E</p></div></div>',1)),rt("div",null,[r[1]||(r[1]=rt("h1",null,"DOOMO",-1)),t.value?pn("",!0):(mt(),At("button",{key:0,onClick:r[0]||(r[0]=o=>i())},"Commencer")),t.value?(mt(),At("h2",KS,"Chargement ...")):pn("",!0)])]))}}),JS=Gi(ZS,[["__scopeId","data-v-c630c4ac"]]),QS={class:"Home"},eE=Hi({__name:"App",setup(n){const{displayIntro:e}=Jn();return(t,i)=>(mt(),At("div",QS,[Mt(e)?pn("",!0):(mt(),no(qS,{key:0})),Mt(e)?(mt(),no(JS,{key:1})):pn("",!0)]))}}),tE=Gi(eE,[["__scopeId","data-v-67266ce0"]]);dm(tE).mount("#app");
